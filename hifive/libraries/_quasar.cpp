...
static const char __pyx_k_Users_msauria_projects_repos_hi[] = "/Users/msauria/projects/repos/hifive/hifive/libraries/_quasar.pyx";
...
static PyObject *__pyx_pf_6hifive_9libraries_7_quasar_find_correlations(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_norms, PyArrayObject *__pyx_v_vrows, PyArrayObject *__pyx_v_corrs, PY_LONG_LONG __pyx_v_start, PY_LONG_LONG __pyx_v_stop); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_6hifive_9libraries_7_quasar_1find_correlations(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_6hifive_9libraries_7_quasar_1find_correlations = {"find_correlations", (PyCFunction)__pyx_pw_6hifive_9libraries_7_quasar_1find_correlations, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6hifive_9libraries_7_quasar_1find_correlations(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_norms,&__pyx_n_s_vrows,&__pyx_n_s_corrs,&__pyx_n_s_start,&__pyx_n_s_stop,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_vrows)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("find_correlations", 1, 5, 5, 1); __PYX_ERR(0, 34, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_corrs)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("find_correlations", 1, 5, 5, 2); __PYX_ERR(0, 34, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_start)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("find_correlations", 1, 5, 5, 3); __PYX_ERR(0, 34, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_stop)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("find_correlations", 1, 5, 5, 4); __PYX_ERR(0, 34, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "find_correlations") < 0)) __PYX_ERR(0, 34, __pyx_L3_error)
      }
    ...
    __pyx_v_start = __Pyx_PyInt_As_PY_LONG_LONG(values[3]); if (unlikely((__pyx_v_start == (PY_LONG_LONG)-1) && PyErr_Occurred())) __PYX_ERR(0, 38, __pyx_L3_error)
    __pyx_v_stop = __Pyx_PyInt_As_PY_LONG_LONG(values[4]); if (unlikely((__pyx_v_stop == (PY_LONG_LONG)-1) && PyErr_Occurred())) __PYX_ERR(0, 39, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("find_correlations", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 34, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("hifive.libraries._quasar.find_correlations", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_norms), __pyx_ptype_5numpy_ndarray, 1, "norms", 0))) __PYX_ERR(0, 35, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_vrows), __pyx_ptype_5numpy_ndarray, 1, "vrows", 0))) __PYX_ERR(0, 36, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_corrs), __pyx_ptype_5numpy_ndarray, 1, "corrs", 0))) __PYX_ERR(0, 37, __pyx_L1_error)
  __pyx_r = __pyx_pf_6hifive_9libraries_7_quasar_find_correlations(__pyx_self, __pyx_v_norms, __pyx_v_vrows, __pyx_v_corrs, __pyx_v_start, __pyx_v_stop);
...
static PyObject *__pyx_pf_6hifive_9libraries_7_quasar_find_correlations(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_norms, PyArrayObject *__pyx_v_vrows, PyArrayObject *__pyx_v_corrs, PY_LONG_LONG __pyx_v_start, PY_LONG_LONG __pyx_v_stop) {
  ...
  __pyx_pybuffernd_corrs.rcbuffer = &__pyx_pybuffer_corrs;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_norms.rcbuffer->pybuffer, (PyObject*)__pyx_v_norms, &__Pyx_TypeInfo_nn___pyx_t_6hifive_9libraries_7_quasar_DTYPE_64_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 34, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_vrows.rcbuffer->pybuffer, (PyObject*)__pyx_v_vrows, &__Pyx_TypeInfo_nn___pyx_t_6hifive_9libraries_7_quasar_DTYPE_int_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 34, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_corrs.rcbuffer->pybuffer, (PyObject*)__pyx_v_corrs, &__Pyx_TypeInfo_nn___pyx_t_6hifive_9libraries_7_quasar_DTYPE_64_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 34, __pyx_L1_error)
  }
 ...
 *     with nogil:
 */
  __pyx_v_N = (__pyx_v_norms->dimensions[0]);
 ...
 */
            ...
            /* "hifive/libraries/_quasar.pyx":51
 *                 if vrows[Y] == 0:
 *                     continue
 *                 X1 = 0.0             # <<<<<<<<<<<<<<
 *                 Y1 = 0.0
 ...
 */
            ...
            /* "hifive/libraries/_quasar.pyx":52
 *                     continue
 *                 X1 = 0.0
 *                 Y1 = 0.0             # <<<<<<<<<<<<<<
 *                 X2 = 0.0
 ...
 */
            ...
            /* "hifive/libraries/_quasar.pyx":54
 *                 Y1 = 0.0
 *                 X2 = 0.0
 *                 Y2 = 0.0             # <<<<<<<<<<<<<<
 *                 XY = 0.0
 ...
 */
            ...
            /* "hifive/libraries/_quasar.pyx":55
 *                 X2 = 0.0
 *                 Y2 = 0.0
 *                 XY = 0.0             # <<<<<<<<<<<<<<
 *                 N = 0
 ...
 *         np.ndarray[DTYPE_int_t, ndim=1] vrows,
 */
  __pyx_tuple__10 = PyTuple_Pack(18, __pyx_n_s_norms, __pyx_n_s_vrows, __pyx_n_s_corrs, __pyx_n_s_start, __pyx_n_s_stop, __pyx_n_s_i, __pyx_n_s_n, __pyx_n_s_X, __pyx_n_s_Y, __pyx_n_s_X1, __pyx_n_s_X2, __pyx_n_s_Y1, __pyx_n_s_Y2, __pyx_n_s_XY, __pyx_n_s_temp, __pyx_n_s_temp1, __pyx_n_s_N, __pyx_n_s_M); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(5, 0, 18, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_msauria_projects_repos_hi, __pyx_n_s_find_correlations, 34, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 *         np.ndarray[DTYPE_int_t, ndim=1] vrows,
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_6hifive_9libraries_7_quasar_1find_correlations, NULL, __pyx_n_s_hifive_libraries__quasar); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_find_correlations, __pyx_t_2) < 0) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
